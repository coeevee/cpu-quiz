...
def answer(ans):
    #makes the variables global so they can be used in the "awnser" function
    global i3orr3
    global i5orr5
    global i7or7
    global i9orr9
    if ans == "end":
        final()
    # the "end" answer calls the "final" function and ends the quiz
    elif ans == "a":
        i3orr3 += 1
        # adds to the score based on the answer being a
    elif ans == "b":
        i5orr5 += 1
        # adds to the score based on the answer being b
    elif ans == "c":
        i7or7 += 1
        i9orr9 += 1
        # adds to the score based on the answer being c
    else:
...
print("c. high end")
answer(input("answer: "))
# calls the "answer" function and adds to the score based on the answer
...
print("c. yes")
answer(input("answer: "))
#ends the quiz by setting the answer to "end"
answer("end")